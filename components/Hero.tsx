...
const Hero = ({ heroData }: { heroData?: HeroData }) => {
  ...
  return (
    <section id="home" className="relative min-h-[600px] md:min-h-[700px] flex items-start md:items-center overflow-hidden">
      ...
      {/* Decorative gradient - kept low to avoid overlapping chips */}
      <div className="absolute bottom-0 left-0 right-0 h-8 md:h-16 bg-gradient-to-t from-background to-transparent z-10" />
    </section>
  );
};
